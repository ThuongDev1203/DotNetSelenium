...
namespace DotNetSelenium
{
    public class LoginTests : BaseTests
    {
        ...
        public void TestLogin()
        {
            ...
            driver.FindElement(By.Id("myvne_email_check")).SendKeys("cuong.0907062600@gmail.com"); // Thay thế bằng ID thực tế của trường username
            driver.FindElement(By.Id("myvne_password_check")).SendKeys("Thuong12345"); // Thay thế bằng ID thực tế của trường password
